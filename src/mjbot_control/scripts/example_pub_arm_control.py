...
class TrajectoryPublisher(Node):
    ...
    def __init__(self):
        ...
        self.trajectory_publisher = self.create_publisher(JointTrajectory,"/arm_joint_trajectory_controller/joint_trajectory", 10)


    def timer_callback(self):

        # creating a point
        goal_positions = [0.0, -1.5, 0.0, 0.0, 1.5, 0.0]
