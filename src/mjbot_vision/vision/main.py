...
class VisionNode(Node):
    ...
    def __init__(self):
        ...
        self.publisher_owner_fall_ = self.create_publisher(
            Bool, "owner_fall", 10)
        self.publisher_depth_distance_ = self.create_publisher(
            Int16, "depth_distance", 10)
    ...
    def publisher_depth_distance(self):
        ...
        # center point range is 80~560. substract 80 to make 0~480 for depth frame size 640x480
        y = self.owner_center[1] - 80
